...
M3D.OrbitCameraControls = class {
    ...
    constructor(camera, orbitCenter) {
        ...
        this._cameraQuaternion = new THREE.Quaternion().setFromUnitVectors(camera.up, new THREE.Vector3(0, 1, 0));
     ...
     * @param {THREE.Vector3} orbitCenter
     */
    ...
    reset() {
        this._orbitCenter = this._resetCenter;
    }
    ...
    focusOn(sphere, offsetDir) {
        ...
        this._camera.lookAt(sphere.center, new THREE.Vector3(0, 1, 0));
...
let _animateHandle = (function () {
    ...
    return function (deltaT) {
        ...
        if (this._currentAnimation == null) {
            ...
            let camDirVec = new THREE.Vector3(0, 0, -1).applyEuler(new THREE.Euler().fromArray(entry.rotation.toArray()));
