...
var Class = global.V_EAMRenderer = V_EAMRenderer;
CommonUtils.inherit(Class, V_AbstractRenderer);
var _ = Class.prototype;

// ========================== CLASS DECLARATION ============================ //

function V_EAMRenderer(gl, options) {
    _.sup.constructor.call(this, gl, options);
