...
(function(global) {
    ...
    _._init = function() {
        ...
        this._renderer =   new MCSRenderer(this._gl, this._volumeTexture, this._environmentTexture);  //new MCSRenderer(this._gl, this._volumeTexture, this._environmentTexture);
