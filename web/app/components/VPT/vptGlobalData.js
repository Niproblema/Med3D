...
app.factory('VPT', ['$rootScope', function ($rootScope) {
    return new (function _vptFactory() {
        ...
        this._gNsModel = {
            ...
            set rendererChoiceID(val) { if (self._activeSettings.rendererChoiceID !== val) { self._activeSettings.rendererChoiceID = val; self._outUpdate({ rendererChoiceID: val }) } },

            eam: {
                get background() { return self._activeSettings.eam.background; },
                set background(val) { if (self._activeSettings.eam.background !== val) { self._activeSettings.eam.background = val; self._outUpdate({ eam: { background: val } }) } },

                get blendMeshRatio() { return self._activeSettings.eam.blendMeshRatio; },
                set blendMeshRatio(val) { if (self._activeSettings.eam.blendMeshRatio !== val) { self._activeSettings.eam.blendMeshRatio = val; self._outUpdate({ eam: { blendMeshRatio: val } }) } },

                get meshLight() { return self._activeSettings.eam.meshLight; },
                set meshLight(val) { if (self._activeSettings.eam.meshLight !== val) { self._activeSettings.eam.meshLight = val; self._outUpdate({ eam: { meshLight: val } }) } },

                get blendMeshColor() {
                    return {
                        get r() { return self._activeSettings.eam.blendMeshColor.r; },
                        set r(val) { if (self._activeSettings.eam.blendMeshColor.r !== val) { self._activeSettings.eam.blendMeshColor.r = val; self._outUpdate({ eam: { blendMeshColor: { r: val } } }) } },
                        get g() { return self._activeSettings.eam.blendMeshColor.g; },
                        set g(val) { if (self._activeSettings.eam.blendMeshColor.g !== val) { self._activeSettings.eam.blendMeshColor.g = val; self._outUpdate({ eam: { blendMeshColor: { g: val } } }) } },
                        get b() { return self._activeSettings.eam.blendMeshColor.b; },
                        set b(val) { if (self._activeSettings.eam.blendMeshColor.b !== val) { self._activeSettings.eam.blendMeshColor.b = val; self._outUpdate({ eam: { blendMeshColor: { b: val } } }) } }
                    }
                },
                set blendMeshColor(val) { if (self._activeSettings.eam.blendMeshColor !== val) { self._activeSettings.eam.blendMeshColor = val; self._outUpdate({ eam: { blendMeshColor: val } }) } },

                get resolution() { return self._activeSettings.eam.resolution; },
                set resolution(val) { if (self._activeSettings.eam.resolution !== val) { self._activeSettings.eam.resolution = val; self._outUpdate({ eam: { resolution: val } }) } },

                get steps() { return self._activeSettings.eam.steps; },
                set steps(val) { if (self._activeSettings.eam.steps !== val) { self._activeSettings.eam.steps = val; self._outUpdate({ eam: { steps: val } }) } },

                get alphaCorrection() { return self._activeSettings.eam.alphaCorrection; },
                set alphaCorrection(val) { if (self._activeSettings.eam.alphaCorrection !== val) { self._activeSettings.eam.alphaCorrection = val; self._outUpdate({ eam: { alphaCorrection: val } }) } },

                get tf() { return self._state.tf.eam; },
                set tf(val) { if (self._state.tf.eam !== val) { self._state.tf.eam = val } },

                get tfBundle() { return self._activeSettings.eam.tfBundle; },
                set tfBundle(val) { if (self._activeSettings.eam.tfBundle !== val) { self._activeSettings.eam.tfBundle = val; self._outUpdate({ eam: { tfBundle: val } }) } }
            },
            iso: {
                get background() { return self._activeSettings.iso.background; },
                set background(val) { if (self._activeSettings.iso.background !== val) { self._activeSettings.iso.background = val; self._outUpdate({ iso: { background: val } }) } },

                get blendMeshRatio() { return self._activeSettings.iso.blendMeshRatio; },
                set blendMeshRatio(val) { if (self._activeSettings.iso.blendMeshRatio !== val) { self._activeSettings.iso.blendMeshRatio = val; self._outUpdate({ iso: { blendMeshRatio: val } }) } },

                get meshLight() { return self._activeSettings.iso.meshLight; },
                set meshLight(val) { if (self._activeSettings.iso.meshLight !== val) { self._activeSettings.iso.meshLight = val; self._outUpdate({ iso: { meshLight: val } }) } },

                get blendMeshColor() {
                    return {
                        get r() { return self._activeSettings.iso.blendMeshColor.r; },
                        set r(val) { if (self._activeSettings.iso.blendMeshColor.r !== val) { self._activeSettings.iso.blendMeshColor.r = val; self._outUpdate({ iso: { blendMeshColor: { r: val } } }) } },
                        get g() { return self._activeSettings.iso.blendMeshColor.g; },
                        set g(val) { if (self._activeSettings.iso.blendMeshColor.g !== val) { self._activeSettings.iso.blendMeshColor.g = val; self._outUpdate({ iso: { blendMeshColor: { g: val } } }) } },
                        get b() { return self._activeSettings.iso.blendMeshColor.b; },
                        set b(val) { if (self._activeSettings.iso.blendMeshRatio.b !== val) { self._activeSettings.iso.blendMeshColor.b = val; self._outUpdate({ iso: { blendMeshColor: { b: val } } }) } }
                    }
                },
                set blendMeshColor(val) { if (self._activeSettings.iso.blendMeshColor !== val) { self._activeSettings.iso.blendMeshColor = val; self._outUpdate({ iso: { blendMeshColor: val } }) } },

                get resolution() { return self._activeSettings.iso.resolution; },
                set resolution(val) { if (self._activeSettings.iso.resolution !== val) { self._activeSettings.iso.resolution = val; self._outUpdate({ iso: { resolution: val } }) } },

                get steps() { return self._activeSettings.iso.steps; },
                set steps(val) { if (self._activeSettings.iso.steps !== val) { self._activeSettings.iso.steps = val; self._outUpdate({ iso: { steps: val } }) } },

                get isoVal() { return self._activeSettings.iso.isoVal; },
                set isoVal(val) { if (self._activeSettings.iso.isoVal !== val) { self._activeSettings.iso.isoVal = val; self._outUpdate({ iso: { isoVal: val } }) } },

                get color() {
                    return {
                        get r() { return self._activeSettings.iso.color.r; },
                        set r(val) { if (self._activeSettings.iso.color.r !== val) { self._activeSettings.iso.color.r = val; self._outUpdate({ iso: { color: { r: val } } }) } },
                        get g() { return self._activeSettings.iso.color.g; },
                        set g(val) { if (self._activeSettings.iso.color.g !== val) { self._activeSettings.iso.color.g = val; self._outUpdate({ iso: { color: { g: val } } }) } },
                        get b() { return self._activeSettings.iso.color.b; },
                        set b(val) { if (self._activeSettings.iso.color.b !== val) { self._activeSettings.iso.color.b = val; self._outUpdate({ iso: { color: { b: val } } }) } }
                    }
                },
                set color(val) { if (self._activeSettings.iso.color !== val) { self._activeSettings.iso.color = val; self._outUpdate({ iso: { color: val } }) } }
            },
            mcs: {
                get background() { return self._activeSettings.mcs.background; },
                set background(val) { if (self._activeSettings.mcs.background !== val) { self._activeSettings.mcs.background = val; self._outUpdate({ mcs: { background: val } }) } },

                get blendMeshRatio() { return self._activeSettings.mcs.blendMeshRatio; },
                set blendMeshRatio(val) { if (self._activeSettings.mcs.blendMeshRatio !== val) { self._activeSettings.mcs.blendMeshRatio = val; self._outUpdate({ mcs: { blendMeshRatio: val } }) } },

                get meshLight() { return self._activeSettings.mcs.meshLight; },
                set meshLight(val) { if (self._activeSettings.mcs.meshLight !== val) { self._activeSettings.mcs.meshLight = val; self._outUpdate({ mcs: { meshLight: val } }) } },

                get blendMeshColor() {
                    return {
                        get r() { return self._activeSettings.mcs.blendMeshColor.r; },
                        set r(val) { if (self._activeSettings.mcs.blendMeshColor.r !== val) { self._activeSettings.mcs.blendMeshColor.r = val; self._outUpdate({ mcs: { blendMeshColor: { r: val } } }) } },
                        get g() { return self._activeSettings.mcs.blendMeshColor.g; },
                        set g(val) { if (self._activeSettings.mcs.blendMeshColor.g !== val) { self._activeSettings.mcs.blendMeshColor.g = val; self._outUpdate({ mcs: { blendMeshColor: { g: val } } }) } },
                        get b() { return self._activeSettings.mcs.blendMeshColor.b; },
                        set b(val) { if (self._activeSettings.mcs.blendMeshColor.b !== val) { self._activeSettings.mcs.blendMeshColor.b = val; self._outUpdate({ mcs: { blendMeshColor: { b: val } } }) } }
                    }
                },
                set blendMeshColor(val) { if (self._activeSettings.mcs.blendMeshColor !== val) { self._activeSettings.mcs.blendMeshColor = val; self._outUpdate({ mcs: { blendMeshColor: val } }) } },

                get resolution() { return self._activeSettings.mcs.resolution; },
                set resolution(val) { if (self._activeSettings.mcs.resolution !== val) { self._activeSettings.mcs.resolution = val;; self._outUpdate({ mcs: { resolution: val } }) } },

                get sigma() { return self._activeSettings.mcs.sigma; },
                set sigma(val) { if (self._activeSettings.mcs.sigma !== val) { self._activeSettings.mcs.sigma = val; self._outUpdate({ mcs: { sigma: val } }) } },

                get alphaCorrection() { return self._activeSettings.mcs.alphaCorrection; },
                set alphaCorrection(val) { if (self._activeSettings.mcs.alphaCorrection !== val) { self._activeSettings.mcs.alphaCorrection = val; self._outUpdate({ mcs: { alphaCorrection: val } }) } },

                get tf() { return self._state.tf.mcs; },
                set tf(val) { if (self._state.tf.mcs !== val) { self._state.tf.mcs = val } },

                get tfBundle() { return self._activeSettings.mcs.tfBundle; },
                set tfBundle(val) { if (self._activeSettings.mcs.tfBundle !== val) { self._activeSettings.mcs.tfBundle = val; self._outUpdate({ mcs: { tfBundle: val } }) } }
            },
            mip: {
                get background() { return self._activeSettings.mip.background; },
                set background(val) { if (self._activeSettings.mip.background !== val) { self._activeSettings.mip.background = val; self._outUpdate({ mip: { background: val } }) } },

                get blendMeshRatio() { return self._activeSettings.mip.blendMeshRatio; },
                set blendMeshRatio(val) { if (self._activeSettings.mip.blendMeshRatio !== val) { self._activeSettings.mip.blendMeshRatio = val; self._outUpdate({ mip: { blendMeshRatio: val } }) } },

                get meshLight() { return self._activeSettings.mip.meshLight; },
                set meshLight(val) { if (self._activeSettings.mip.meshLight !== val) { self._activeSettings.mip.meshLight = val; self._outUpdate({ mip: { meshLight: val } }) } },

                get blendMeshColor() {
                    return {
                        get r() { return self._activeSettings.mip.blendMeshColor.r; },
                        set r(val) { if (self._activeSettings.mip.blendMeshColor.r !== val) { self._activeSettings.mip.blendMeshColor.r = val; self._outUpdate({ mip: { blendMeshColor: { r: val } } }) } },
                        get g() { return self._activeSettings.mip.blendMeshColor.g; },
                        set g(val) { if (self._activeSettings.mip.blendMeshColor.g !== val) { self._activeSettings.mip.blendMeshColor.g = val; self._outUpdate({ mip: { blendMeshColor: { g: val } } }) } },
                        get b() { return self._activeSettings.mip.blendMeshColor.b; },
                        set b(val) { if (self._activeSettings.mip.blendMeshColor.b !== val) { self._activeSettings.mip.blendMeshColor.b = val; self._outUpdate({ mip: { blendMeshColor: { b: val } } }) } }
                    }
                },
                set blendMeshColor(val) { if (self._activeSettings.mip.blendMeshColor !== val) { self._activeSettings.mip.blendMeshColor = val; self._outUpdate({ mip: { blendMeshColor: val } }) } },

                get resolution() { return self._activeSettings.mip.resolution; },
                set resolution(val) { if (self._activeSettings.mip.resolution !== val) { self._activeSettings.mip.resolution = val; self._outUpdate({ mip: { resolution: val } }) } },

                get steps() { return self._activeSettings.mip.steps; },
                set steps(val) { if (self._activeSettings.mip.steps !== val) { self._activeSettings.mip.steps = val; self._outUpdate({ mip: { steps: val } }) } }
            },

            reinhard: {
                get exposure() { return self._activeSettings.reinhard.exposure; },
                set exposure(val) { if (self._activeSettings.reinhard.exposure !== val) { self._activeSettings.reinhard.exposure = val; self._outUpdate({ reinhard: { exposure: val } }) } }
            },
            range: {
                get rangeLower() { return self._activeSettings.range.rangeLower; },
                set rangeLower(val) { if (self._activeSettings.range.rangeLower !== val) { self._activeSettings.range.rangeLower = val; self._outUpdate({ range: { rangeLower: val } }) } },

                get rangeHigher() { return self._activeSettings.range.rangeHigher; },
                set rangeHigher(val) { if (self._activeSettings.range.rangeHigher !== val) { self._activeSettings.range.rangeHigher = val; self._outUpdate({ range: { rangeHigher: val } }) } }
            },

            get useMCC() { return self._activeSettings.useMCC; },
            set useMCC(val) { if (self._activeSettings.useMCC !== val) { self._activeSettings.useMCC = val; self._outUpdate({ useMCC: val }) } },
        ...
        this._updateUIsidebar = function (update) {
            ...
            if (update == null)
                ...
                $rootScope.$broadcast('refreshVPTsidebar', update);
        }
